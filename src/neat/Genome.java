...
public final class Genome {
    ...
    public static Genome crossover(Genome higherFitness, Genome lowerFitness){
        Genome temp = new Genome(higherFitness);
        for(Entry<Integer, ConnectionGene> entry: temp.connectionGenes.entrySet()){
